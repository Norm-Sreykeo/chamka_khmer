                          ...
                          child: Row(
                            children: [
                              _CategoryChip(
                                ...
                                onTap: () => catalog.selectCategory(1 as String?),
                              ),
                              _CategoryChip(
                                icon: '🥭',
                                label: 'Mango',
                                isSelected: catalog.selectedCategoryId == 2,
                                onTap: () => catalog.selectCategory(2 as String?),
                              ),
                              _CategoryChip(
                                icon: '🥦',
                                label: 'Broccoli',
                                isSelected: catalog.selectedCategoryId == 3,
                                onTap: () => catalog.selectCategory(3 as String?),
                              ),
                              _CategoryChip(
                                icon: '🥕',
                                label: 'Carrot',
                                isSelected: catalog.selectedCategoryId == 4,
                                onTap: () => catalog.selectCategory(4 as String?),
                              ),
                            ],
                          ),
                        ),
